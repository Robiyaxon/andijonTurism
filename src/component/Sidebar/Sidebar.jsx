...
const Saidbar = () => {
  ...
  const items = [
    ...
    getItem(t("Resorts"), "sub2", <AreaChartOutlined />, [
      ...
      getItem(
        <NavLink to="https://www.google.com/search?sca_esv=577545666&tbs=lf:1,lf_ui:1&tbm=lcl&sxsrf=AM9HkKmm79vfjRstgp6QeWk28BPNnz0ObQ:1698557012428&q=Teatr+andijon&rflfq=1&num=10&sa=X&ved=2ahUKEwjg0ez6wZqCAxVjR_EDHV0eDp8QjGp6BAgPEAE&biw=1348&bih=629&dpr=1.42#rlfi=hd:;si:;mv:[[40.785147099999996,72.3580844],[40.741694599999995,72.3458971]];tbs:lrf:!1m4!1u2!2m2!2m1!1e1!2m1!1e2!3sIAE,lf:1,lf_ui:1">
          Teatr
        </NavLink>,
        "7"
      ),
